...
export const INITIAL_USERS: UserProfile[] = [
  ...
  {
    uid: 'user_student_2',
    email: 'student2@study.iitm.ac.in',
  ...
  {
    uid: 'user_student_3',
    email: 'student3@study.iitm.ac.in',
    name: 'Kavita Menon',
    phone: '+91 9711223344',
    region: 'South',
    level: 'Degree',
  ...
  {
    uid: 'user_head_1',
    email: 'kaziranga.head@study.iitm.ac.in',
    name: 'Siddharth Rao',
    phone: '+91 9833445566',
    region: 'North',
    level: 'Degree',
  ...
  {
    uid: 'user_archived_1',
    email: 'rahul.alumni@study.iitm.ac.in',
    name: 'Rahul Sen',
    phone: '+91 9871122334',
    region: 'East',
    level: 'Degree',
    ...
    updatedAt: new Date().toISOString(),
    lastLoginAt: new Date(Date.now() - 12 * 86400000).toISOString(),
  },
  {
    uid: 'user_archived_2',
    email: 'sneha.patel@study.iitm.ac.in',
    name: 'Sneha Patel',
    phone: '+91 9765432190',
    region: 'West',
    level: 'Foundation',
    ...
    role: 'USER',
    isAccessRevoked: true,
    revokedAt: new Date(Date.now() - 3 * 86400000).toISOString(),
    createdAt: new Date(Date.now() - 45 * 86400000).toISOString(),
    updatedAt: new Date().toISOString(),
    lastLoginAt: new Date(Date.now() - 20 * 86400000).toISOString(),
  },
];
...
export const INITIAL_REGISTRATIONS: Registration[] = [
  ...
  },
  {
    ...
    eventId: 'evt_cricket_2026',
    eventTitle: 'Kaziranga Inter-House Cricket Championship 2026',
    userId: 'user_archived_1',
    nameSnapshot: 'Rahul Sen',
    emailSnapshot: 'rahul.alumni@study.iitm.ac.in',
    phoneSnapshot: '+91 9871122334',
    regionSnapshot: 'East',
    levelSnapshot: 'Degree',
    programmeSnapshot: 'BS Data Science',
    registrationType: 'INDIVIDUAL',
    status: 'CONFIRMED',
    createdAt: new Date(Date.now() - 20 * 86400000).toISOString(),
  ...
  {
    id: 'reg_005',
    eventId: 'evt_esports_valorant',
    eventTitle: 'Kaziranga E-Sports Valorant Championship',
    userId: 'user_archived_1',
    nameSnapshot: 'Rahul Sen',
    emailSnapshot: 'rahul.alumni@study.iitm.ac.in',
    phoneSnapshot: '+91 9871122334',
