...
export const INITIAL_EVENTS: EventItem[] = [
  {
    ...
    name: 'Kaziranga Intra-House Cricket Championship 2026',
  ...
  },
  {
    ...
    description: 'Tactical 5v5 FPS tournament! Clashing for supremacy and house points in the annual Intra-House Gaming League.',
...
export const INITIAL_REGISTRATIONS: Registration[] = [
  {
    ...
    eventTitle: 'Kaziranga Intra-House Cricket Championship 2026',
...
export const INITIAL_NOTIFICATIONS: NotificationItem[] = [
  ...
  },
  {
    ...
    message: 'Your spot in Kaziranga Intra-House Cricket Championship 2026 has been successfully registered.',
    type: 'SUCCESS',
